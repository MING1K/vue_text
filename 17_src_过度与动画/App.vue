...
import MoveAction2 from './components/MoveAction2.vue'
import AnimateUse from './components/AnimateUse.vue'
...
export default {
    ...
    mounted(){
        ...
        this.pubId = pubsub.subscribe('deleteTodo2',this.deleteTodo2)
    },
    beforeDestroy(){
